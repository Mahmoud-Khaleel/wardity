  ...
  return (
    <nav className="w-full bg-black text-white px-6 md:px-10 py-4 flex items-center justify-between font-poppins">
      <div className="flex items-center gap-10">
        <h1 className="text-xl font-semibold tracking-wide cursor-pointer hover:text-pink-400">
          <Link to="/">wardity</Link>
        </h1>
        ...
        <ul className="hidden md:flex items-center gap-8 text-sm">
          ...
          <li className="hover:text-pink-400 cursor-pointer">
            <Link to="products" onClick={handleShop}>
              Shop
            </Link>
          </li>
          <li className="hover:text-pink-400 cursor-pointer">
      ...
      <div className="flex items-center gap-6 relative" ref={menuRef}>
        <div
          className="flex flex-col text-sm hover:text-pink-400 transition-colors duration-200 cursor-pointer"
        ...
        {user && (
          <div className="relative">
            <Menu
              ...
              className="w-6 h-6 cursor-pointer hover:text-pink-400"
            />
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white text-black rounded-lg shadow-lg py-2 z-50">
                <Link
                  to="/profile"
                  className="block px-4 py-2 hover:bg-pink-400 text-sm"
                >
                  Profile
                </Link>
                <Link
                ...
                <Link
                  to="/login"
                  onClick={logout}
                  className="block w-full text-left px-4 py-2 hover:bg-pink-400 text-sm text-red-500 cursor-pointer"
                >
                  Logout
                </Link>
              </div>
